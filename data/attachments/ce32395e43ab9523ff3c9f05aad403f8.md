...
- generic [ref=e2]:
  ...
  - generic [ref=e48]:
    ...
    - generic [ref=e53]:
      ...
      - generic [ref=e185]: There are no products found.
  - paragraph [ref=e188]:
    - text: This is a DEMO application (
    - link "GitHub repo" [ref=e189] [cursor=pointer]:
      - /url: https://github.com/testsmith-io/practice-software-testing
    - text: ), used for software testing training purpose. |
    - link "Privacy Policy" [ref=e190] [cursor=pointer]:
      - /url: /privacy
    - text: "| Banner photo by"
    - link "Barn Images" [ref=e191] [cursor=pointer]:
      - /url: https://unsplash.com/@barnimages
    - text: "on"
    - link "Unsplash" [ref=e192] [cursor=pointer]:
      - /url: https://unsplash.com/photos/t5YUoHW6zRo
    - text: .
  - button "Open chat" [ref=e194] [cursor=pointer]:
    - img [ref=e195]
```